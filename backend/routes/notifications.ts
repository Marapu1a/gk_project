...
import { deleteAllNotificationsHandler } from '../handlers/notifications/deleteAllNotificationsHandler';
...
export async function notificationsRoutes(app: FastifyInstance) {
  ...
  app.delete('/notifications', { preHandler: [verifyToken] }, deleteAllNotificationsHandler);
