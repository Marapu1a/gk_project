...
import { requestDocumentReviewFileDeletion } from '../handlers/documentReview/requestDocumentReviewFileDeletion';
...
export async function documentReviewRoutes(app: FastifyInstance) {
  ...
  app.post(
    '/document-review-request/files/:fileReviewId/deletion-request',
    { preHandler: [verifyToken] },
    requestDocumentReviewFileDeletion,
  );
}
