...
export async function meHandler(req: FastifyRequest, reply: FastifyReply) {
  ...
  const dbUser = await prisma.user.findUnique({
    ...
    select: {
      ...
      bio: true,
      ibaoId: true,
      supervisionEthicsAcceptedAt: true,
  ...
  return reply.send({
    ...
    supervisionEthicsAcceptedAt: dbUser.supervisionEthicsAcceptedAt,
    externalSupervisorClaimStatus: dbUser.externalSupervisorClaimStatus,
