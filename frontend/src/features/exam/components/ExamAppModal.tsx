...
export default function ExamAppModal({ app, onClose }: ExamAppModalProps) {
  ...
  return (
    <ModalShell
      ...
      ariaLabelledBy="exam-application-title"
      dialogClassName="relative max-h-[92vh] w-full max-w-[1080px] overflow-y-auto rounded-[16px] bg-white px-6 py-6 shadow-[0_12px_32px_rgba(0,0,0,0.24)]"
    >
      <ModalCloseButton onClick={onClose} />

      <h3 id="exam-application-title" className="dashboard-v2-page-title mb-5 text-center">
        Заявка на экзамен
      </h3>
