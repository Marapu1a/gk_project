...
export function PaymentModal({
  ...
  const handleTogglePending = async () => {
    try {
      ...
      toast.error(getUiErrorMessage(error, 'Не удалось обновить статус оплаты'));
    }
  };
  ...
  return (
    <ModalShell
      ...
      dialogClassName="relative max-h-[90vh] w-full max-w-[520px] overflow-y-auto rounded-[28px] bg-white p-6 shadow-strong"
    >
      <div className="mb-5 flex items-start justify-between gap-4">
        <div>
          <h3 id="payment-modal-title" className="dashboard-v2-page-title text-[#1F305E]">
            {title}
          </h3>
